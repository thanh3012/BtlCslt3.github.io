<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebDongHo.Login" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style2">
                <tr>
                    <td class="auto-style3" colspan="3"><strong>ĐĂNG NHẬP HỆ THỐNG<br />
                        </strong></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Button ID="btnDangNhap" runat="server" CssClass="auto-style1" Height="33px" OnClick="btnDangNhap_Click" Text="Đăng nhập" />
                    </td>
